...
layui.define(['jquery', 'element', 'layer', 'laydate', 'layedit', 'view', 'table', 'form', 'admin', 'upload'], function(exports) {
    console.log("seniorPartnerApply");
    var form = layui.form;
    ...
    table.render({
        elem: "#LAY-seniorPartnerApply-list"
        , url: "/api/events/getSeniorPartnerApplylist"
        , method: "post"
        , toolbar: "#Lay-seniorPartnerApply-list-toolbar"
        , cols: [[
            ...
            , {title: "操作", width: 150, align: "center", fixed: "right", toolbar: "#LAY-seniorPartnerApply-list-tool-tages"}
        ]]
        , defaultToolbar: []
        ,height: 'full-150'
        , page: true
    ...
    table.on("tool(LAY-seniorPartnerApply-list)", function(obj) {
                        ...
                        layer.prompt({
                            ...
                            admin.req({
                                ...
                                , success: function(res) {
                                    if (res.code == 0) {
                                        table.reload("LAY-seniorPartnerApply-list");
                                    }
                                    layer.closeAll();
                                    layer.msg(res.msg);
                                }
