layui.define(['jquery', 'element', 'layer', 'laydate', 'layedit', 'view', 'table', 'form', 'admin', 'upload'], function(exports) {
    ...
    table.render({
        elem: "#LAY-factoryHR-list"
        , url: "/api/factory/getInputEvent"
        , method: "post"
        , toolbar: "#Lay-factoryHR-list-toolbar"
        , cols: [[
            ...
            , {width: 100, width: 120, align: "center", title: "工厂HR人数", templet: function (d) {
                return d.factory.hrcount+"人";
            }}
            ...
            // , {title: "操作", width: 100, align: "center", fixed: "right", toolbar: "#LAY-factoryHR-list-tool-tages"}
        ]]
        // , cellMinWidth: 100
        , defaultToolbar: []
        ,height: 'full-150'
    ...
    table.on("tool(LAY-factoryHR-list)", function(obj) {
    ...
    table.on("toolbar(LAY-factoryHR-list)", function(obj) {
