...
{
    /**
     * 查看 readme.txt说明文本,创建公钥 私钥
     */
    const certFile = __DIR__.'/data/allinpay-pds.pem';//通联公钥证书
    const privateKeyFile = __DIR__.'/data/20060400000106404.pem';//商户私钥证书
    const password = '111111';//商户私钥密码以及用户密码
//	const  apiUrl = 'http://172.16.1.11:8080/aipg/ProcessServlet';//通联系统对接请求地址（内网）
    public $arrayXml;
    const apiUrl = 'https://tlt.allinpay.com/aipg/ProcessServlet';//通联系统对接请求地址（外网,商户测试时使用）
